...
- (void)setupArrays
{
    ...
    descriptions = @[@"I am 17 years old high school student who lives in a small town in northern Germany with a population of only 20k people, called [REDACTED]. I developed an interest for technology and software very already. So, I started learning HTML when I was about 12 years old. When I got an iPod touch in 2009 I was amazed by it and that's basically where the story began.",
                     @"Soon I wanted to know how apps are being built and how I can build my own ones.\n\nAfter my mom bought me my first Intel-based Mac in 2012, I also bought a book to learn Objective-C. I was fascinated by the language, by the APIs and by the possibilities. So, I spent more and more time coding my own apps and studying the language and the system.",
                     ...
                     @"In September 2013 I took part in YRS Berlin which is a hackathon. I used my knowledge to build an iOS app that recommends you clothes to wear – based on the weather forecasts. Our project was called \"Kleiderfrosch\" and won in the category \"Should Exist\". So, that was my first hackathon.",
